...
sections.forEach(s=>io.observe(s));document.querySelector('.menu-btn').onclick=()=>document.querySelector('.site-nav').classList.toggle('open');navLinks.forEach(a=>a.onclick=()=>document.querySelector('.site-nav').classList.remove('open'));
