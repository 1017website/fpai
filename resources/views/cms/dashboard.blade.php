...
<div class="stat-grid">
    ...
    <div class="stat-card"><span>Berita terbit</span><strong>{{ $stats['news'] }}</strong></div>
</div>
<div class="two-col">
    <section class="card"><div class="card-header"><h2>Akses cepat</h2></div><div class="card-body"><div class="actions"><a class="btn btn-primary" href="{{ route('cms.pages.index') }}">Kelola Halaman</a><a class="btn btn-secondary" href="{{ route('cms.news.index') }}">Kelola Berita</a><a class="btn btn-secondary" href="{{ route('cms.settings.edit') }}">SEO & Tracking</a></div></div></section>
    <section class="card"><div class="card-header"><h2>Ringkasan sistem</h2></div><div class="card-body"><p><b>{{ $stats['users'] }}</b> akun CMS tersedia.</p><p>Konten frontend dikelola melalui menu <b>Halaman Frontend</b>, <b>Berita</b>, dan <b>Pengaturan & SEO</b>.</p></div></section>
</div>
